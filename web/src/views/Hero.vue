          ...
          <div>
            ...
            <m-card plain icon="menu" title="出装推荐" class="hero-items">
              ...
              <div class="d-flex jc-around text-center mt-3">
                <div v-for="item in model.items1" :key="item.name" class="items-con">
              ...
              <div class="d-flex jc-around text-center mt-3">
                <div v-for="item in model.items2" :key="item.name" class="items-con">
                  <img :src="item.icon" class="icon">
                  <div class="fs-xs">{{item.name}}</div>
                </div>
              </div>
            ...
            <m-card plain icon="menu" title="英雄关系">
              ...
              class="d-flex pt-3">
                <img :src="item.hero.avatar" alt="" style="height: 4rem; width: 4rem; border-radius: 15%;">
